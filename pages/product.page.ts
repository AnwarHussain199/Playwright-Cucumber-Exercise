...
export class Product {
    ...
    private readonly backpackButton: string = 'button[data-test="add-to-cart-sauce-labs-backpack"]';
    private readonly sortDropdown: string = '.product_sort_container';
    private readonly itemPrices: string = '.inventory_item_price';
    private addToCartButtonSelector: string = 'button[data-test^="add-to-cart"]';
...
function $$(arg0: string): Locator | PromiseLike<Locator> {
